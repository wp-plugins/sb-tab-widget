...
class SB_Tab_Widget extends WP_Widget {
	public function __construct() {
		parent::__construct( 'sb_tab_widget', 'SB Tab', array(
			...
			'description' => __('Display widget on tabber.', 'sb-tab-widget'),
		));
	}
	...
	public function widget($args, $instance) {
		...
		if(empty($sidebar)) {
			echo '<p>'.__('Please choose sidebar first.', 'sb-tab-widget').'</p>';
			...
			<div class="sb-tab-widget">
				...
				<div class="tab-content sb-tab-container">
					...
					<?php else : ?>
						...
						?>
						<p><?php printf(__('Please put widget into sidebar %s.', 'sb-tab-widget'), $sidebar_name); ?></p>
					<?php endif; ?>
				</div>
			</div>
		<?php }
	...
	public function form($instance) {
		...
		<div class="sb-tab-widget sb-widget">
            ...
            $args = array(
                ...
                'value'         => $title,
                'label_text'    => __('Title:', 'sb-tab-widget'),
                'description'   => ''
            );
            ...
            $args = array(
                ...
                'label_text' => __('Choose sidebar:', 'sb-tab-widget' ),
